                ...
                return (
                    <div key={product.id} className="block group h-full">
                        <div className="bg-[#F3EBF6] hover:bg-[#ebdcf0] rounded-none p-6 transition-colors h-full flex flex-col min-h-[200px] relative">
                            {/* Notification Badge */}
                            {unreadCount > 0 && (
                                <div className="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold w-6 h-6 flex items-center justify-center rounded-full shadow-md z-10 animate-bounce">
                            ...
                            <div className="mt-auto pt-4 border-t border-purple-200">
                                ...
                                >
                                    ...
                                    Views Issue
                                    {unreadCount > 0 && (
                                        <span className="ml-1 bg-white text-[#4B286D] text-[10px] font-bold px-1.5 py-0.5 rounded-full">
                                            {unreadCount} New
                                        </span>
                                    )}
                                </Link>
